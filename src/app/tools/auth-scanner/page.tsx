...
import { getDb, apiPost } from "@/lib/auth-api";
import type { AppEvent, AppUser, ScanRecord, DbData } from "@/lib/auth-api";
...
export default function AuthScannerPage() {
  ...
  const startScanner = useCallback(
    async (cameraMode: "environment" | "user" = "environment") => {
      ...
      const scanner = new Html5Qrcode("auth-scanner-reader");
